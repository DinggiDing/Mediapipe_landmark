    ...
    andOrientation orientation: UIImage.Orientation) -> [HandOverlay] {
      ...
      for handLandmarks in landmarks {
        ...
        default:
          ...
          print(handLandmarks[4].x, handLandmarks[4].y, handLandmarks[4].z)
          print(handLandmarks[6].x, handLandmarks[6].y, handLandmarks[6].z)
          print(handLandmarks[7].x, handLandmarks[7].y, handLandmarks[7].z)

          print(handLandmarks[10].x, handLandmarks[10].y, handLandmarks[10].z)

//          if handLandmarks[8].z > 0.3 {
//              print("a")
//          }
          print("----------")
